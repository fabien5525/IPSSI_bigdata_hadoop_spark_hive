...
Copy data/mal/anime.csv to the namenode.
```
  docker cp data/mal/anime.csv namenode:data/mal/anime.csv
```
...
```
  hdfs dfs -mkdir -p /data/mal
```

Copy data/mal/anime.csv to HDFS:
```
  hdfs dfs -put data/mal/anime.csv /data/mal/anime.csv
```
...
Load data/mal/anime.csv from HDFS.
```
  brewfile = spark.read.csv("hdfs://namenode:9000/data/openbeer/breweries/data/mal/anime.csv")
...
Load data/mal/anime.csv from HDFS.
```
  val df = spark.read.csv("hdfs://namenode:9000/data/openbeer/breweries/data/mal/anime.csv")
